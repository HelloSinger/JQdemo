...
public class CalendarCellView extends FrameLayout {
  ...
  public void setDateTag(boolean visible){
    dateTag.setVisibility(visible ? VISIBLE : INVISIBLE);
  }
  public void setMonthTextViewColor(boolean isTody,boolean isSelectable,boolean isCurrentMonth,boolean isSelect){
    if(isTody){
      dayOfMonthTextView.setTextColor(getResources().getColor(R.color.mainColor));
    }else if(!isCurrentMonth){
      dayOfMonthTextView.setTextColor(getResources().getColor(R.color.white));
    }else if(!isSelectable){
      dayOfMonthTextView.setTextColor(getResources().getColor(R.color.calendar_text_unselectable));
    }else if(isSelect){
      dayOfMonthTextView.setTextColor(getResources().getColor(R.color.white));
    }else {
      dayOfMonthTextView.setTextColor(getResources().getColor(R.color.calendar_text_highlighted));
    }
  }
}
