...
public class NewMainActivity extends FragmentActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private void initView() {
        trend_rb = (RadioButton) findViewById(R.id.trend_rb);
        dynamic_rb = (RadioButton) findViewById(R.id.dynamic_rb);
        trend_shop = (RadioButton) findViewById(R.id.trend_shop);
        find_rb = (RadioButton) findViewById(R.id.find_rb);
        me_rb = (RadioButton) findViewById(R.id.me_rb);
        mTabRg = (RadioGroup) findViewById(R.id.main_tab);
